...
class Weather():
    def weather_report(self):
        ...
        # self.url = "https://api.openweathermap.org/data/2.5/weather?q={Busan}&appid={4344b0c5d63fb946ca403d0675a37478}"

        self.cityname =  self.loc.get(1.0 ,END)
        self.cityname = 'Seoul'
        self.api_key = '4344b0c5d63fb946ca403d0675a37478'
    ...
    def __init__(self):
        ...
        self.button = Button(self.root ,text="Search" ,bg="#00274c" ,fg="white" ,font=self.font ,relief=RAISED
