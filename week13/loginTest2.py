...
Label(d_frame, text="ID", font=('함초롬바탕', 15), fg='#1F50B5', ).grid(row=0, column=0, padx=20)
Label(d_frame, text="PASSWORD", font=('함초롬바탕', 15), fg='#1F50B5').grid(row=1, column=0)
...
Button(d_frame, text="로그인", font=('맑은고딕', 10), command=show).grid(row=0, column=2, rowspan=2, padx=0, pady=0, ipadx=5, ipady=30)
